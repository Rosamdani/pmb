...
if (isset($_POST['submit-next']) || isset($_POST['submit-next2'])) {
    $valid = true;
    $nama = $_POST['nama'];
    $alamat = $_POST['alamat'];
    $nik = $_POST['nik'];
    ...
    if ($valid) {
        $query = mysqli_query($con, "INSERT INTO pendaftar (`id_user`,`nama`,`pil1`,`pil2`,`nik`,`alamat`) VALUES ('$id_user','$nama','$jurusan','$jurusan2','$nik','$alamat')");
        if ($query) {
    ...
    <form action="" method="POST" class="bg-body">
        ...
        <div class="container pt-12 mt-10">
            <div class="m-auto w-[400px] flex justify-between">
                <button name="submit-prev" class="flex items-center">
                    <div class="text-white px-[13px] py-1 rounded-full bg-slate-600 mr-3">1</div>
                    Data Diri
                </button>
                <button name="submit-next2" class="flex items-center">
            ...
            <div class="w-[400px] mx-auto h-5 bg-slate-200 rounded-full mt-4">
                <div class="w-[50%] h-full bg-emerald-500 rounded-l-full"></div>
            </div>
        </div>
            ...
            <div class="w-[80%] border-r-2 border-slate-200 box-border bg-slate-200">
                ...
                <div class="px-4 py-2 text-slate-500 bg-white">
                    ...
                    <div class="container h-10 rounded-sm border border-slate-300 overflow-hidden flex mt-4">
                        ...
                        <input required type="text" placeholder="Nama lengkap" name="nama" class="w-full outline-emerald-300 px-3">
                    </div>
                    ...
                    <div class="container h-10 rounded-sm border border-slate-300 overflow-hidden flex mt-4">
                        ...
                        <input required type="text" placeholder="NIK" name="nik" class="w-full outline-emerald-300 px-3">
                    </div>
                    ...
                    <div class="container h-10 rounded-sm border border-slate-300 overflow-hidden flex mt-4">
                        ...
                        <input required type="text" placeholder="Alamat" name="alamat" class="w-full outline-emerald-300 px-3">
                    </div>
                    ...
                    <div class="container h-10 rounded-sm border border-slate-300 overflow-hidden flex mt-4">
                        ...
                        <select required name="jurusan" class="w-full outline-emerald-300 px-3">
                    ...
                    <p class="text-red-400"><?= @$errorAlamat ?></p>
                    <div class="container h-10 rounded-sm border border-slate-300 overflow-hidden flex mt-4">
                        <select required name="jurusan2" class="w-full outline-emerald-300 px-3">
                            <option value="">--Pilih Jurusan--</option>
                            <?php
                    ...
                    <div class="container h-10 rounded-sm overflow-hidden flex mt-4">
                        <button name="submit-next" class="w-24 hover:bg-emerald-600 h-full bg-emerald-500 rounded text-white font-semibold">
